...
import { Category_Api, sub_Category_Api, GST_Api, Customer_Api, Delete_item_Api, Update_Invoice, Get_Sales_Details_Api } from '../api/authApi';
              ...
              <View key={item.id} style={{ marginBottom: 10 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                  <View style={{ flexDirection: 'row', marginBottom: 5 }}>
                    ...
                    <Text style={{ fontWeight: '700', color: 'black', fontSize: 15 }}> {item.category}</Text>
                  </View>
                ...
                <View style={{ flexDirection: 'row', marginBottom: 5 }}>
                  ...
                  <Text style={{ fontWeight: '700', color: 'black', fontSize: 15 }}> {item.sub_category}</Text>
                </View>

                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                  <View style={{ flexDirection: 'row', marginBottom: 5 }}>
                    <Text style={{ fontWeight: '600' }}>Price:</Text>
                    <Text style={{ fontWeight: '700', color: 'black', fontSize: 15 }}> {item.price}</Text>
                  </View>
                  <View style={{ flexDirection: 'row', marginBottom: 5 }}>
                    <Text style={{ fontWeight: '600' }}>Quantity:</Text>
                    <Text style={{ fontWeight: '700', color: 'black', fontSize: 15 }}> {item.qty}</Text>
                  </View>
                </View>

                <View style={{ flexDirection: 'row', marginBottom: 5 }}>
                  <Text style={{ fontWeight: '600' }}>GST:</Text>
                  <Text style={{ fontWeight: '700', color: 'black', fontSize: 15 }}> {item.gst}</Text>
                </View>

                <View style={{ flexDirection: 'row', marginBottom: 5 }}>
                  <Text style={{ fontWeight: '600' }}>Commission:</Text>
                  <Text style={{ fontWeight: '700', color: 'black', fontSize: 15 }}> {item.commision}</Text>
                </View>

                <View style={{ flexDirection: 'row', marginBottom: 5 }}>
                  <Text style={{ fontWeight: '600' }}>Description:</Text>
                  <Text style={{ fontWeight: '700', color: 'black', fontSize: 15 }}> {item.description}</Text>
                </View>

                <View style={{ flexDirection: 'row', marginBottom: 5 }}>
                  <Text style={{ fontWeight: '600' }}>GST Type:</Text>
                  <Text style={{ fontWeight: '700', color: 'black', fontSize: 15 }}> {item.gst_type}</Text>
                </View>
              </View>
            ))}
          </View>
